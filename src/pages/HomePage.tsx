...
export function HomePage({ account, onLogout, onJoinMeeting, onViewUsers, onViewFileServer, onViewSharedWithMe, notifications, onClearNotification, onMarkAsRead, onAddNotification }: HomePageProps) {
